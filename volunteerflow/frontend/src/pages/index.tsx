...
export default function Dashboard() {
  ...
  const stats = [
    ...
    },
    {
      ...
      changeColor: 'text-danger-600 dark:text-danger-400'
    },
    {
      title: 'Total Hours',
      value: '8,456',
  ...
  return (
    <Layout>
      <div className="space-y-6">
          ...
          <Card className="p-6">
            <div className="mb-6">
              ...
              <p className="text-sm text-neutral-600 dark:text-neutral-400 mt-1">
                Monthly volunteer registration trends
              </p>
            </div>
        ...
        {/* Bottom Section: Upcoming Events & Recent Applications & Top Volunteers */}
